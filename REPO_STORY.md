...
2. **Lognormal structure**: Gap distributions are lognormal across all scales and bands — 100% of 6 tested bands pass distributional tests with p-values > 0.05. This implies **multiplicative randomness** in gap formation.

3. **Autocorrelation**: Gaps exhibit memory. At 10^8, 98% of tested lags show significant autocorrelation (Ljung-Box p < 0.05). Gaps are not independent events.
